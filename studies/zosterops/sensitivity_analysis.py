...
default_settings = {
    ...
    "perfecttol":10.0,
    # species parameters
    "species":'[Dict("lineage"=>"archetype","precopt"=>20,"prectol"=>10,"tempopt"=>293,"temptol"=>2)]',
...
alternate_perfecttol=[10.0]
alternate_phylconstr=[0.05]
alternate_mutationrate=[2.5e11]
alternate_dispmean=[18]
alternate_dispshape=[2.0]
...
def run_default():
    ...
    shutil.copy("studies/zosterops/Chyulu_Taita_Maps2/Chyulu_025.map", ".")
