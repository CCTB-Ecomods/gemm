...
This README covers [installation](https://github.com/CCTB-Ecomods/gemm#setting-up-the-model) 
and [basic usage](https://github.com/CCTB-Ecomods/gemm#instructions-for-use) 
of the software. Further documentation may be found in the following documents:
...
- `docs/HACKING.md` instructions for development work on the model, tailored to the
  Zosterops study.
